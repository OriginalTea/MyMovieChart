...
//  MyMovieChart
//
//  Created by Kim Jun Soo on 11/01/2019.
...
class TheatherListController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
        //self.list배열에서 행에 맞는 데이터를 꺼냄
        let obj = self.list[indexPath.row]
        
        NSLog("\(obj["상영관명"] as? String), 호출된 행번호: \(indexPath.row)")
    ...
    func callTheaterAPI(){
        ...
        do{
            ...
            do{
                ...
                //경고창 형식으로 오류 메세지를 보내준다
                self.alert("데이터를 불러오는데 실패하였습니다.")
